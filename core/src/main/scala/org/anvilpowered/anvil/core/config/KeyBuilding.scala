...
inline def [reified T : Any] Key.Companion.buildSimple(
 ...
 */
context(KeyNamespace)
inline def [reified T : Any] Key.Companion.buildingSimple(
  type: TypeToken[T] = typeTokenOf(),
 ...
 */
context(KeyNamespace)
inline def [reified E : Any] Key.Companion.buildList(
 ...
 */
context(KeyNamespace)
inline def [reified E : Any] Key.Companion.buildingList(
  elementType: TypeToken[E] = typeTokenOf(),
 ...
 */
context(KeyNamespace)
inline def [reified K : Any, reified V : Any] Key.Companion.buildMap(
 ...
 */
context(KeyNamespace)
inline def [reified K : Any, reified V : Any] Key.Companion.buildingMap(
  keyType: TypeToken[K] = typeTokenOf(),
  valueType: TypeToken[V] = typeTokenOf(),
...
@PublishedApi
internal inline def [reified T] typeTokenOf() = object : TypeToken[T]() {}
