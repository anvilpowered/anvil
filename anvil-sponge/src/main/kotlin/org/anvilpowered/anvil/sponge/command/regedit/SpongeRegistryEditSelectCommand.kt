...
class SpongeRegistryEditSelectCommand : CommonRegistryEditSelectCommand<User, Player, Text, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonRegistryEditCommandNode.SELECT_DESCRIPTION))
        val USAGE: Text get() = Text.of("/$alias regedit select ${CommonRegistryEditCommandNode.SELECT_USAGE}")
    }
