...
class SpongeRegistryEditStartCommand : CommonRegistryEditStartCommand<User, Player, Text, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonRegistryEditCommandNode.START_DESCRIPTION))
        val USAGE: Text get() = Text.of("/$alias regedit start ${CommonRegistryEditCommandNode.START_USAGE}")
    }
