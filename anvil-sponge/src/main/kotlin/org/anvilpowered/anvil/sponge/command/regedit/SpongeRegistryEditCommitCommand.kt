...
class SpongeRegistryEditCommitCommand : CommonRegistryEditCommitCommand<User, Player, Text, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonRegistryEditCommandNode.COMMIT_DESCRIPTION))
        val USAGE: Text get() = Text.of("/$alias regedit commit")
    }
