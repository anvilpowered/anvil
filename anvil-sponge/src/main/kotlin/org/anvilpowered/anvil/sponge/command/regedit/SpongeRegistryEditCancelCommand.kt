...
class SpongeRegistryEditCancelCommand : CommonRegistryEditCancelCommand<User, Player, Text, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonRegistryEditCommandNode.CANCEL_DESCRIPTION))
        val USAGE: Text get() = Text.of("/$alias regedit cancel")
    }
