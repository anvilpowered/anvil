...
class VelocityRegistryEditSelectCommand
  : CommonRegistryEditSelectCommand<Player, Player, TextComponent?, CommandSource>(), SimpleCommand {
  override fun execute(invocation: SimpleCommand.Invocation) =
    super.execute(invocation.source(), invocation.arguments())

  override fun suggest(invocation: SimpleCommand.Invocation): List<String> =
    super<CommonRegistryEditSelectCommand>.suggest(invocation.source(), invocation.arguments())
}
