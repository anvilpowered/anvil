...
class VelocityRegistryEditSelectCommand
    : CommonRegistryEditSelectCommand<Player, Player, TextComponent?, CommandSource>(), Command {
    override fun execute(source: CommandSource, context: Array<String>) =
        super<CommonRegistryEditSelectCommand>.execute(source, context)

    override fun suggest(source: CommandSource, context: Array<String>): List<String> =
        super<CommonRegistryEditSelectCommand>.suggest(source, context)
}
