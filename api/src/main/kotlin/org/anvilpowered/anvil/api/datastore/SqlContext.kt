...
class SqlContext @Inject constructor(registry: Registry) : DataStoreContext<UUID?, HikariDataSource?>(registry) {
  public override fun loadDataStore(): HikariDataSource? {
 ...
 */
  ...
  override fun closeConnection(dataStore: HikariDataSource?) {
    dataStore.close()
  }
}
