...
interface EnvironmentManager {
  ...
  fun getEnvironments(pattern: Pattern?): List<Environment?>?
  fun getEnvironment(pattern: Pattern?): Optional<Environment?>?
  fun getEnvironment(name: String?): Optional<Environment?>?
}
