...
public class BungeeStringResult extends CommonStringResult<TextComponent, CommandSender> {

    @Override
    public Builder<TextComponent, CommandSender> builder() {
        return new BungeeStringResultBuilder();
    }
    ...
    private static final class BungeeStringResultBuilder extends CommonStringResultBuilder<TextComponent, CommandSender> {
        private final List<Object> elements;
        private HoverEvent hoverEvent;
        private ClickEvent clickEvent;

        private BungeeStringResultBuilder() {
