...
import rocks.milspecsg.msrepository.service.common.config.ConfigKeys;
import rocks.milspecsg.msrepository.service.common.config.MSConfigurationService;
...
public class MSRepositoryTest {
    ...
    private static class MSRepositoryTestModule extends CommonConfigurationModule {
        @Override
        protected void configure() {
            super.configure();
            bind(new TypeLiteral<CommonConfigurationService>() {}).to(new TypeLiteral<MSConfigurationService>() {});
