...
public interface TextService<TCommandSource> {
  ...
  /**
   * Removes all styles codes from the provided {@link String} using the character {@literal '&'} to determine styles
   *
   * <p>
  ...
  /**
   * Counts the number of characters in the provided {@link Component} excluding color codes.
   *
   * @param text {@link Component} text to count characters
   * @return The number of characters in the provided {@link Component}. -1 if null. 0 if empty.
   */
  ...
  interface Builder<TCommandSource> {
     ...
     * Append the provided contents to this builder.
     *
     * @param contents The {@link CharSequence} contents to append
     * @return {@code this}
     */
    Builder<TCommandSource> append(CharSequence... contents);

    /**
     * Append the provided contents to this builder {@code count} times.
     *
     * <p>
     ...
     * @param contents The {@link Object} contents to append
     * @return {@code this}
     */
     ...
     * <br>
     * <p>
     * If the value for padding is longer than one character, the appended result may not reach the full provided {@code width}.
     ...
     * <strong>at most</strong> {@code width} wide.
     *
     * <p>
     * An example of usage is:
     * </p>
     ...
     * result is <strong>at most</strong> {@code width} wide.
     *
     * <p>
     * An example of usage is:
     * </p>
    ...
    /**
     * Append the provided contents if {@code condition} is true, putting the provided delimiter between each element
     *
     * <p>
    ...
    /**
     * Suggest the provided command to the provided{@link TCommandSource} when they click This puts it in their chat bar but
    ...
    /**
     * Creates a {@link Component} from this builder and sends it to the console.
     */
    void sendToConsole();
  }
