...
package rocks.milspecsg.anvil.api.data.key;
...
public final class Keys {
    ...
    public static final Key<String> BASE_SCAN_PACKAGE = new Key<String>("BASE_SCAN_PACKAGE", "rocks.milspecsg.anvil.core.common.model") {
    };
