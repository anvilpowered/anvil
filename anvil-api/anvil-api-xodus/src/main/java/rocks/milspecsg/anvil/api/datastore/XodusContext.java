...
import rocks.milspecsg.anvil.api.datastore.annotation.XodusEmbedded;
import rocks.milspecsg.anvil.api.datastore.annotation.XodusEntity;
import rocks.milspecsg.anvil.api.model.Mappable;
    ...
    protected PersistentEntityStore loadDataStore() {
        ...
        for (Class<?> entityClass : entityClasses) {
            if (Mappable.class.isAssignableFrom(entityClass)) {
                ...
                throw new IllegalStateException("Xodus entity class " + entityClass.getName() + " must extend rocks.milspecsg.anvil.model.data.dbo.Mappable");
            }
        }
