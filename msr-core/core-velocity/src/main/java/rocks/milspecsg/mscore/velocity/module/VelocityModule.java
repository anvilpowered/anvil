...
package rocks.milspecsg.mscore.velocity.module;
...
public class VelocityModule extends CommonModule<TextComponent, CommandSource> {
    ...
    protected void configure() {
        super.configure();
        File configFilesLocation = Paths.get("plugins/" + MSCorePluginInfo.id).toFile();
        ...
        }).toInstance(HoconConfigurationLoader.builder().setPath(Paths.get(configFilesLocation + "/mscore.conf")).build());
    }
}
